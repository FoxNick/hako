...
internal sealed class HakoRegistry
{
    ...
    private void InitializeFunctions()
    {
        ...
        _newBigInt = TryCreateFuncInt32WithLong<int, long>("HAKO_NewBigInt");
        _getBigInt = TryCreateFuncInt64<int, int>("HAKO_GetBigInt");
        _newBigUInt = TryCreateFuncInt32WithLong<int, long>("HAKO_NewBigUInt");
        _getBigUInt = TryCreateFuncInt64<int, int>("HAKO_GetBigUInt");
        _newDate = TryCreateFuncInt32WithDouble<int, double>("HAKO_NewDate");
        _isDate = TryCreateFuncInt32<int>("HAKO_IsDate");
        _isMap = TryCreateFuncInt32<int>("HAKO_IsMap");
        _isSet = TryCreateFuncInt32<int>("HAKO_IsSet");
        _getDateTimestamp = TryCreateFuncDouble<int, int>("HAKO_GetDateTimestamp");
    ...
    private Func<int, long, int>? _newBigInt;
    private Func<int, int, long>? _getBigInt;
    private Func<int, long, int>? _newBigUInt;
    private Func<int, int, long>? _getBigUInt;
    private Func<int, double, int>? _newDate;
    private Func<int, int>? _isDate;
    private Func<int, int>? _isMap;
    private Func<int, int>? _isSet;
    private Func<int, int, double>? _getDateTimestamp;
...
private Func<int, long, int>? TryCreateFuncInt32WithLong<T1, T2>(string functionName)
{
    return _instance.GetFunctionInt32WithLong<T1, T2>(functionName);
}
...
private Func<int, int, long>? TryCreateFuncInt64<T1, T2>(string functionName)
{
    return _instance.GetFunctionInt64<T1, T2>(functionName);
}
...
private Action<int, int, int>? TryCreateAction<T1, T2, T3>(string functionName)
{
    ...
    /// <returns>Exception sentinel. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>New Error object. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>New object with memory stats. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <param name="rt">Runtime to query</param>
    /// <returns>String with memory stats. Caller owns, free with HAKO_RuntimeFree.</returns>
    ...
    /// <returns>HAKO_STATUS_SUCCESS on success, error code on failure</returns>
    ...
    /// <returns>HAKO_Status indicating success or specific error type</returns>
    ...
    /// <returns>Pointer to static undefined. Never free.</returns>
    ...
    /// <returns>Pointer to static null. Never free.</returns>
    ...
    /// <returns>Pointer to static false. Never free.</returns>
    ...
    /// <returns>Pointer to static true. Never free.</returns>
    ...
    /// <returns>New runtime or NULL on failure. Caller owns, free with HAKO_FreeRuntime.</returns>
    ...
    /// <param name="rt">Runtime to query</param>
    /// <returns>Current strip flags</returns>
    ...
    /// <returns>New context or NULL on failure. Caller owns, free with HAKO_FreeContext.</returns>
    ...
    /// <returns>User data previously set, or NULL. Host owns.</returns>
    ...
    /// <returns>New value pointer. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>Allocated memory or NULL. Caller owns, free with HAKO_Free.</returns>
    ...
    /// <param name="size">Bytes to allocate</param>
    /// <returns>Allocated memory or NULL. Caller owns, free with HAKO_RuntimeFree.</returns>
    ...
    /// <param name="ctx">Context to create in</param>
    /// <returns>New object. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <param name="ctx">Context to create in</param>
    /// <returns>New array. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>New ArrayBuffer. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>New number. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>Double value, or NAN on error</returns>
    ...
    /// <returns>New string value. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <param name="ctx">Context</param>
    /// <param name="val">Value to convert. Host owns.</param>
    /// <returns>C string or NULL on error. Caller owns, free with HAKO_FreeCString.</returns>
    ...
    /// <returns>New buffer copy or NULL on error. Caller owns, free with HAKO_Free.</returns>
    ...
    /// <returns>Evaluation result. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>New symbol. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>Symbol description string. Caller owns, free with HAKO_FreeCString.</returns>
    ...
    /// <returns>True if global symbol</returns>
    ...
    /// <returns>True if jobs pending, false otherwise</returns>
    ...
    /// <returns>Number of jobs executed, or -1 on error</returns>
    ...
    /// <returns>Property value or NULL on error. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>NULL on success, exception value on error. Caller owns exception, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>Function result. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>Error object or NULL if no exception. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>String representation. Caller owns, free with HAKO_FreeCString.</returns>
    ...
    /// <returns>Module namespace object. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>HAKOTypeOf enum value</returns>
    ...
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if null, 0 if not</returns>
    ...
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if undefined, 0 if not</returns>
    ...
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if null or undefined, 0 otherwise</returns>
    ...
    /// <returns>1 if equal, 0 if not, -1 on error</returns>
    ...
    /// <param name="ctx">Context to use</param>
    /// <returns>Global object. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>New promise. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <param name="ctx">Context</param>
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if promise, 0 if not</returns>
    ...
    /// <returns>JSPromiseStateEnum (pending, fulfilled, or rejected)</returns>
    ...
    /// <param name="ctx">Context</param>
    /// <param name="val">Promise value. Host owns.</param>
    /// <returns>Fulfillment value or rejection reason. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>1 if debug build, 0 if release build</returns>
    ...
    /// <returns>New function value. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>Pointer to value at index. Host owns.</returns>
    ...
    /// <param name="out_len">Output pointer for buffer length</param>
    /// <returns>Encoded buffer. Caller owns, free with HAKO_Free.</returns>
    ...
    /// <param name="len">Buffer length in bytes</param>
    /// <returns>Decoded value. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <param name="ctx">Context</param>
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if array, 0 if not, -1 on error</returns>
    ...
    /// <param name="ctx">Context</param>
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if typed array, 0 if not, -1 on error</returns>
    ...
    /// <returns>JSTypedArrayEnum value (Int8Array, Uint32Array, etc.)</returns>
    ...
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if ArrayBuffer, 0 if not</returns>
    ...
    /// <returns>JSON string value. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>Parsed value. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <param name="ctx">Context</param>
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if Error, 0 if not</returns>
    ...
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if exception, 0 if not</returns>
    ...
    /// <param name="ctx">Context to create in</param>
    /// <param name="value">64-bit signed integer value</param>
    /// <returns>New BigInt. Caller owns, free with HAKO_FreeValuePointer.</returns>
    public JSValuePointer NewBigInt(JSContextPointer ctx, long value)
    {
        return Hako.Dispatcher.Invoke(() =>
        {
            if (_newBigInt == null)
                throw new InvalidOperationException("HAKO_NewBigInt not available");
            return _newBigInt(ctx, value);
        });
    }

    /// <summary>Converts a JavaScript value to a 64-bit signed integer</summary>
    /// <param name="ctx">Context</param>
    /// <param name="val">Value to convert. Host owns.</param>
    /// <returns>64-bit signed integer value, or 0 on error (check for exceptions)</returns>
    public long GetBigInt(JSContextPointer ctx, JSValuePointer val)
    {
        return Hako.Dispatcher.Invoke(() =>
        {
            if (_getBigInt == null)
                throw new InvalidOperationException("HAKO_GetBigInt not available");
            return _getBigInt(ctx, val);
        });
    }

    /// <summary>Creates a new BigInt from 64-bit unsigned value</summary>
    /// <param name="ctx">Context to create in</param>
    /// <param name="value">64-bit unsigned integer value</param>
    /// <returns>New BigInt. Caller owns, free with HAKO_FreeValuePointer.</returns>
    public JSValuePointer NewBigUInt(JSContextPointer ctx, ulong value)
    {
        return Hako.Dispatcher.Invoke(() =>
        {
            if (_newBigUInt == null)
                throw new InvalidOperationException("HAKO_NewBigUInt not available");
            return _newBigUInt(ctx, (long)value);
        });
    }

    /// <summary>Converts a JavaScript value to a 64-bit unsigned integer</summary>
    /// <param name="ctx">Context</param>
    /// <param name="val">Value to convert. Host owns.</param>
    /// <returns>64-bit unsigned integer value, or 0 on error (check for exceptions)</returns>
    public ulong GetBigUInt(JSContextPointer ctx, JSValuePointer val)
    {
        return Hako.Dispatcher.Invoke(() =>
        {
            if (_getBigUInt == null)
                throw new InvalidOperationException("HAKO_GetBigUInt not available");
            return (ulong)_getBigUInt(ctx, val);
        });
    }
    ...
    /// <returns>New Date object. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <summary>Checks if a value is a Date object</summary>
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if Date, 0 if not</returns>
    public int IsDate(JSValuePointer val)
    {
        return Hako.Dispatcher.Invoke(() =>
        {
            if (_isDate == null)
                throw new InvalidOperationException("HAKO_IsDate not available");
            return _isDate(val);
        });
    }

    /// <summary>Checks if a value is a Map object</summary>
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if Map, 0 if not</returns>
    public int IsMap(JSValuePointer val)
    {
        return Hako.Dispatcher.Invoke(() =>
        {
            if (_isMap == null)
                throw new InvalidOperationException("HAKO_IsMap not available");
            return _isMap(val);
        });
    }

    /// <summary>Checks if a value is a Set object</summary>
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>1 if Set, 0 if not</returns>
    public int IsSet(JSValuePointer val)
    {
        return Hako.Dispatcher.Invoke(() =>
        {
            if (_isSet == null)
                throw new InvalidOperationException("HAKO_IsSet not available");
            return _isSet(val);
        });
    }

    /// <summary>Gets the timestamp from a Date object</summary>
    /// <param name="ctx">Context</param>
    /// <param name="val">Date value. Host owns.</param>
    /// <returns>Milliseconds since Unix epoch (UTC), or NAN if not a Date</returns>
    public double GetDateTimestamp(JSContextPointer ctx, JSValuePointer val)
    {
        return Hako.Dispatcher.Invoke(() =>
        {
            if (_getDateTimestamp == null)
                throw new InvalidOperationException("HAKO_GetDateTimestamp not available");
            return _getDateTimestamp(ctx, val);
        });
    }

    /// <summary>Gets the class ID of a value</summary>
    /// <param name="val">Value to check. Host owns.</param>
    /// <returns>Class ID, or 0 if not an object with a class</returns>
    ...
    /// <returns>1 if instance, 0 if not, -1 on error</returns>
    ...
    /// <returns>Pointer to build info struct. Host owns.</returns>
    ...
    /// <returns>Bytecode buffer or NULL on error. Caller owns, free with HAKO_Free.</returns>
    ...
    /// <returns>New module definition. Freed when context is freed.</returns>
    ...
    /// <param name="ctx">Context</param>
    /// <param name="mod">Module definition</param>
    /// <returns>Module name. Host owns.</returns>
    ...
    /// <returns>The allocated class ID</returns>
    ...
    /// <returns>Constructor function. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <param name="ctx">Context</param>
    /// <param name="class_id">Class ID</param>
    /// <returns>New object instance. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>Opaque data pointer, or NULL if wrong class. Host owns.</returns>
    ...
    /// <param name="ctx">Context</param>
    /// <param name="mod">Module definition</param>
    /// <returns>Private value. Caller owns, free with HAKO_FreeValuePointer.</returns>
    ...
    /// <returns>New typed array. Caller owns, free with HAKO_FreeValuePointer.</returns>
